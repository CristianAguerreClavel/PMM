...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       textoPeso.setOnClickListener(new OnClickListener() {
            @Override
       ...
       Spinner spinner = (Spinner)findViewById(R.id.spinerZona);
        ...
        class AdaptadorSpinnerZona extends ArrayAdapter {
            ...
            public View getView(int position, View convertView, ViewGroup parent)
            {
                ...
                holder.precio.setText(String.valueOf(datos[position].getPrecio()));
...
/*-----------------------------------------------------------------------------------------------------*/
        ...
        calcular.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                //double precioTotal = 0;//la e añadido para probar el proyecto
                //Creamos el Itent
